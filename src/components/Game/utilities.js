...
export const strikeBonus = (roll1, roll2) =>
  10 + roll1 + roll2

export const isSpare = (roll1, roll2) =>
  roll1 + roll2 === 10
...
export const getFrameIndex = frames =>
  frames.length - 1
...
export const calculateFrameScore = (rolls, frames, frameScores, pins, lastScore) => {
